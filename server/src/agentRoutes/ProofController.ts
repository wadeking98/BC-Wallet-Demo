import type { Agent, ProofPredicateInfo } from '@aries-framework/core'

import { AttributeFilter, PredicateType } from '@aries-framework/core'
...
export const issueProof = async (agent: Agent, connId: string, comment: string, proof: any) => {
  ...
  const predicateObject: Record<string, ProofPredicateInfo> = {}
