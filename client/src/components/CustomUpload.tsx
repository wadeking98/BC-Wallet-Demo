...
export const CustomUpload: React.FC = () => {
    ...
    const onSubmitHandler = () => {
        ...
        reader.onload = (evt: any) => {
            ...
            dispatch(uploadCharacter({ character: uploadedChar, callback: () => { dispatch(setUploadingStatus(false)) } }))
        };
    ...
    return (
        <>
            <Modal title="Upload custom character" onOk={onSubmitHandler} okText="UPLOAD" okDisabled={!uploadFile} loading={isUploading} loadingText='Adding new schemas and credential defenitions to the ledger. Please be patient, this can take a few minutes.' onCancel={close} description="">
