...
export const SmallButton: React.FC<Props> = ({ text, onClick, disabled }) => {
  return (
    <motion.button
      ...
      className={`text-sm bg-black dark:bg-white text-white font-semibold dark:text-bcgov-black py-1.5 px-6 rounded transition duration-300 ease-in-out transform shadow-sm ${
